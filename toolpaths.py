...
def init(Machine_Type,Axes): # Returns a class with all of the toolpath commands
    ...
    class TOOLPATH_FUNCTIONS:
        ...
        def Spawn_Safe_Code():
            TOOLPATH_FUNCTIONS.Toolpath+=":1111 (Toolpath generated by toolpaths.py)\ng90 g20;\n"
        ...
        def X(Location):
            ...
            if "." in str(Location):
                ...
                raise Exception("Cannot go to x, invalid location")


            if TOOLPATH_FUNCTIONS.Mode=="FEED":
                TOOLPATH_FUNCTIONS.Toolpath+="X "+str(Location)+";\n"
            elif TOOLPATH_FUNCTIONS.Mode=="RAPID":
                TOOLPATH_FUNCTIONS.Toolpath+="X "+str(Locations)+";\n"
            else:
        ...
        def Y(Location):
            ...
            if "." in str(Location):
                ...
                raise Exception("Cannot go to y, invalid location") 
        ...
        def Z(Location):
            ...
            if "." in str(Location):
                ...
                raise Exception("Cannot go to z, invalid location")
